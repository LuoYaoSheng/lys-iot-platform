      ...
      child: Padding(
        ...
        child: Column(
          children: [
            Container(
              width: 80, height: 80,
              decoration: BoxDecoration(color: isOnline ? Colors.green.withOpacity(0.1) : Colors.grey.withOpacity(0.1), shape: BoxShape.circle),
              ...
              children: [
                Expanded(
                  child: RadioListTile<String>(
                    title: const Text('Toggle 模式'),
                    subtitle: const Text('开关灯场景'),
                    value: 'toggle',
                ...
                Expanded(
                  child: RadioListTile<String>(
                    title: const Text('Pulse 模式'),
                    subtitle: const Text('开电脑场景'),
                    value: 'pulse',
                    groupValue: _controlMode,
                    onChanged: (value) { setState(() { _controlMode = value!; }); },
                  ),
