...
Write-Host "MySQL: localhost:48306" -ForegroundColor Yellow
Write-Host "Redis: localhost:48379" -ForegroundColor Yellow
Write-Host ""
Write-Host "=== ESP32 连接地址 ===" -ForegroundColor Cyan
Write-Host "API Server: http://${LOCAL_IP}:48080" -ForegroundColor Green
Write-Host "MQTT Broker: ${LOCAL_IP}:48883" -ForegroundColor Green
Write-Host "EMQX Dashboard: http://${LOCAL_IP}:48884 (admin/public)" -ForegroundColor Yellow
Write-Host ""
